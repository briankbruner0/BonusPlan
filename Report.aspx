<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="BonusPlan.Report" %>
...
<body>
    ...
    <asp:Literal ID="SecurityMenu" EnableViewState="false" runat="server"></asp:Literal>
        <table style="width: 750px; margin-left: 7px;" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td align="left">
                    <asp:Literal ID="ReportNavigationGrid" runat="server" EnableViewState="false"></asp:Literal>
                </td>
            </tr>
        </table>
    </form>
