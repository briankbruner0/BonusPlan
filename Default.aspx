<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BonusPlan.Default" %>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" id="ApprovalApproveControl">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input class="btn btn-default btn-sm" onclick="ResetModal(); $('#ApprovalDetailModal').modal('toggle'); " type="button" value="Cancel" />
                            </div>
                        </div>
                        <div class="row" id="ApprovalExceptionControl" style="display: none;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input class="btn btn-default btn-sm" onclick="ResetModal();" type="button" value="Cancel" />
                            </div>
                        </div>
                    </div>
                </div>
