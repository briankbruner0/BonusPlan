...
namespace BonusPlan
{
    public partial class rptBonusPlanByMoveInDate : Page, IDataSearchForm
    {
        ...
        public DataSet rptBonusPlanbyMoveInDTGet()
        {
            DataSet ds = new DataSet();

            using (SqlConnection Connection = new SqlConnection(ConfigurationManager.AppSettings["WebApplication"]))
            {
                using (SqlCommand Command = new SqlCommand("BonusPlan.rptBonusPlanbyMoveInDT", Connection))
                {
        ...
        public void Search()
        {
            ...
            dsExtract = rptBonusPlanbyMoveInDTGet();
            ...
            AtriaBase.UI.MicrosoftOfficeUtility.ExportData(dsExtract, "rptBonusPlanbyMoveInDT", fields, AtriaBase.UI.OfficeExportType.Excel);
        }
