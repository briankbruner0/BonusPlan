<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptBonusPlanRevenue.aspx.cs" Inherits="BonusPlan.rptBonusPlanRevenue" %>
...
<head id="Head1" runat="server">
    ...
    <%--07/24/2017 Patrick Fette This was missing. Contains isDate Function that is needed for validation to fix Elmah hit--%>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="25%">
                                    <input type="button" value="Cancel" name="Cancel" class="button" onclick="javascript: window.location = 'rptBonusPlanRevenue.aspx?'" />&nbsp;
                                </td>
                                <td width="25%">&nbsp;
                                </td>
                                <td width="25%">&nbsp;
